...
function LoginPage() {
    ...
    <section>
            ...
            <div className='w-full h-full bg-silver h-screen py-12'>
                <h1 className="text-4xl text-center">Visitors Management System</h1><p className="text-1xl text-center">Manage your project and team in easy way</p><img className="w-80 max-w-full mx-auto my-10" src={Frame} alt="artwork" /></div>
